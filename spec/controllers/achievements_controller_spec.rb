...
describe AchievementsController do 
    ...
    shared_examples "public access to achievements" do
        ...
        describe "GET index" do
            ...
            it "assigns only public achievements to template" do
                public_achievement = FactoryBot.create(:public_achievement, user: FactoryBot.create(:user))
                private_achievement = FactoryBot.create(:private_achievement, user: FactoryBot.create(:user))
                get :index
    ...
    describe "guest user" do
        ...
        describe "GET edit" do
            it "redirects to login page" do
                put :edit, params: { id: FactoryBot.create(:public_achievement)  } 
        ...
        context "is the owner of the achievement" do
            ...
            describe "PUT update" do
                ...
                describe "DELETE destroy" do
                    ...
                    it "deletes achievements form database" do
                        delete :destroy , params: { id: achievement.id }
